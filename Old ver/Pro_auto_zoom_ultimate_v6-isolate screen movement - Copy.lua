...
function script_properties()
    ...
    obs.obs_properties_add_color(props,      "ind_color",   "Ring Color:")
    obs.obs_properties_add_int_slider(props, "ind_opacity", "Ring Opacity (%):", 10, 100, 5)
    obs.obs_properties_add_int_slider(props, "ind_size",    "Ring Size (px):",   20, 300, 5)
...
local function get_canvas_bounds()
    ...
    -- TODO: "pip" (Picture-in-Picture / Avoid Corners) is offered as a Smart Canvas
    -- Layout option in the dropdown but has no distinct handling here yet - it
    -- currently falls through to the same behavior as "full". Implement a real
    -- PiP branch (or remove/relabel the option as "Coming Soon") before relying on it.
